...
namespace UXCountryWorld {
    ...
    public partial class LocalDBWorldCountryDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/LocalDBWorldCountryDataSet.xsd";
...
namespace UXCountryWorld.LocalDBWorldCountryDataSetTableAdapters {
    ...
    public partial class CountryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Country] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Code = 1 AND [Code] IS NULL) OR ([Code] = @Original_Code)) AND ((@IsNull_Capital = 1 AND [Capital] IS NULL) OR ([Capital] = @Original_Capital)) AND ((@IsNull_Population = 1 AND [Population] IS NULL) OR ([Population] = @Original_Population)) AND ((@IsNull_RegionID = 1 AND [RegionID] IS NULL) OR ([RegionID] = @Original_RegionID)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Country] ([Id], [Name], [Code], [Capital], [Population], [RegionID])" +
                " VALUES (@Id, @Name, @Code, @Capital, @Population, @RegionID);\r\nSELECT Id, Name," +
                " Code, Capital, Population, RegionID FROM Country WHERE (Id = @Id)";
...
SELECT Id, Name, Code, Capital, Population, RegionID FROM Country WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Code, Capital, Population, RegionID FROM Country";
